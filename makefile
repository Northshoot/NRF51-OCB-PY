PROJECT_NAME := blinky_blank_pca10031
MAIN_FILE := main.c
...
TEMPLATE_PATH = $(NRF51SDK)/components/toolchain/gcc
...
C_SOURCE_FILES += \
$(NRF51SDK)/components/toolchain/system_nrf51.c \
$(NRF51SDK)/components/drivers_nrf/hal/nrf_delay.c \
$(NRF51SDK)/components/libraries/uart/retarget.c \
$(NRF51SDK)/components/libraries/fifo/app_fifo.c \
$(NRF51SDK)/components/libraries/util/app_error.c \
...
INC_PATHS += -I$(NRF51SDK)/components/toolchain/gcc
INC_PATHS += -I$(NRF51SDK)/components/toolchain
INC_PATHS += -I$(NRF51SDK)/components/drivers_nrf/uart
